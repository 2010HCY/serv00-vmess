...
menu() {
   clear
   echo ""
   purple "=== serv00 |  vmess一键安装脚本 ===\n"
   purple "静水深流博客所有者制作，转载请注明出处\n"
   echo -e "${green}脚本地址：${re}${yellow}https://github.com/2010hcy/serv00-vmess${re}\n"
   echo -e "${green}博客：${re}${yellow}https://2010hcy.us.kg${re}\n"
   purple "静水深流博客所有者制作，转载请注明出处\n"
   green "1. 安装vmess"
   echo  "==============="
   red "2. 卸载vmess"
